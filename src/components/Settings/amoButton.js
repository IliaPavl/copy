...
function start() {
  ...
  oauth_scripts.forEach(function (oauth_script) {
    ...
    var centerAuthWindow = function (url, title) {
      var w = 750;
      var h = 580;
      var dual_screen_left = window.screenLeft !== undefined ? window.screenLeft : window.screen.left;
      var dual_screen_top = window.screenTop !== undefined ? window.screenTop : window.screen.top;
